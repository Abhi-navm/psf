...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$PSScriptRoot\backend'; & '.\.venv\Scripts\python.exe' -m celery -A app.tasks.celery_app worker --loglevel=info --pool=solo"
